...
- **Paid Family and Medical Leave (c. 175M)**: Private employers with 25+ covered individuals contribute 0.88% of payroll (effective 1/1/27: shifted employer responsibility); employees entitled to up to 16 weeks unpaid leave with job restoration and benefits protection.
- **Wage Act strict compliance**: Final pay on discharge due same day; on resignation, next regular payday; treble damages (triple pay) for violations plus attorney fees; 3-year statute of limitations.
- **Noncompete enforceability restricted (M.G.L. c. 149 § 24L)**: Non-competes require garden leave (50% of salary during restriction period, prorated). Restrictions must be reasonable in duration, geography, and scope.
- **Personnel record access (c. 149 § 52C)**: Employers with 20+ employees must notify workers within 10 days of adding negative information to file; employees may access file within 5 business days; records retained 3 years post-termination.
- **Ban-the-box (c. 151B § 4(9½))**: Employers cannot ask about criminal history on initial application; may inquire after interview stage; 3-year look-back for misdemeanors; sealed/erased convictions fully protected.
...
- Termination for performing public duties (jury duty, voting, military service).
- Termination for exercising statutory rights (e.g., filing rebuttal in personnel record per M.G.L. c. 149 § 52C).
- Termination in violation of well-defined public policy (whistleblowing, wage theft reporting).
- Implied employment contract: oral or written promises of job security, detailed employment practices, or established course of dealing may create enforceable contract beyond at-will terms.
...
- Minimum wage is $15.00/hour (unchanged since January 1, 2023; M.G.L. c. 151 § 1).
- Service rate (tipped employees) is $6.75/hour, provided tips + wages equal at least $15.00/hour.
...
- Wages must be paid on a regular, designated payday, at least weekly (M.G.L. c. 149 § 148).
- **On discharge/termination**: Full wages, accrued vacation, and earned paid time off must be paid **same day** (M.G.L. c. 149 § 148).
- **On resignation**: Full wages and accrued paid time off due on next regular payday.
- Failure to pay final wages on time triggers treble damages (3x unpaid wages) plus reasonable attorney fees (M.G.L. c. 149 § 150).
...
**Salary history ban (M.G.L. c. 149 § 105A(c)(2))**:

- Employers may not inquire about, request, or rely on an applicant's previous wage/salary history before extending an offer.
- Employers may not direct third parties (recruiters, references) to inquire about salary history.
- Previous wage/salary history is not a defense in equal-pay litigation.
- Exception: candidate may voluntarily disclose history.

**Pay data reporting (M.G.L. c. 149 § 105F(b))**:

- Employers with 100+ Massachusetts employees who file federal wage-data reports (EEO-1, EEO-3, EEO-4, EEO-5) must file annual or biennial equivalent report with Massachusetts Secretary of the Commonwealth (effective February 1, 2025).
- Reports must track wages by gender, race, ethnicity, job category to monitor wage-equity trends.
...
- Employees accrue 1 hour paid sick time per 30 hours worked, capped at 40 hours per benefit year.
- Employers with 11+ employees must provide **paid** sick leave; employers with fewer than 11 must provide unpaid.
- Accrual begins on hire date; **employees cannot use accrued time until 90th calendar day of employment**, though accrual begins immediately.
- Employees may use sick leave for: own serious health condition, child's/spouse's/parent's serious health condition, workplace closure due to public emergency, domestic violence/sexual assault-related needs.
- Employers may require certification after 3 consecutive days of use.
- Accrual continues during unpaid PFML leave.
...
- **Contribution rates** (effective 2026; shifted January 1, 2027):
  ...
  - Employers with fewer than 25: 0.46% (entirely employee-paid).
...
- Employers with 20+ employees must retain personnel records without deletions for 3 years after termination (M.G.L. c. 149 § 52C).
- Medical records must be kept separately and retained at least 3 years.
- Payroll records (name, address, hours, wages, deductions) must be maintained for 3 years minimum (M.G.L. c. 149 § 49).
- No maximum retention period specified; longer retention is permitted.

**Employee access to personnel files (M.G.L. c. 149 § 52C)**:

- Employees of employers with 20+ employees may inspect and copy their personnel records.
- **Timeline**: Employer must provide access within **5 business days** of written request.
- **Frequency**: Maximum 2 inspections per calendar year without employer consent (unless work-related action triggers additional inspection right).
- **Cost**: Employer may charge reasonable fee related to copying costs.
- **Disputed information**: If employee disagrees with file information, employee may submit written statement of their position; employer must maintain statement in file and provide it to any third party receiving file disclosure.

**Required notifications**:

- Employer must notify employee **within 10 days** of placing any information in personnel file that is, has been, or may be used to negatively affect qualification for employment, promotion, transfer, compensation, or subject employee to discipline (M.G.L. c. 149 § 52C).

**Record format**:

- No Massachusetts statute mandates electronic vs. paper format; employers may maintain records electronically if retention and access requirements are met.
...
- Definition: Unauthorized acquisition or use of unencrypted personal information (or encrypted data with confidential decryption process/key) that creates substantial risk of identity theft or fraud.
- **Notification timeline**: "As soon as practicable and without unreasonable delay" to affected residents, Massachusetts Attorney General, and Office of Consumer Affairs and Business Regulation.
- **Content**: Nature of breach, number of MA residents affected, remediation steps taken, contact information, types of personal information compromised, responsible party (if known).
- **Consequence**: Employers must offer free credit monitoring to affected individuals.

**Data residency or processing constraints**:

- No Massachusetts law mandates data residency for employee records; employers may process/store in-state or out-of-state if data security and privacy laws are met.
...
- Noncompete agreements are enforceable if supported by **garden leave clause** or other mutually-agreed consideration.
- **Garden leave clause definition**: Employer agrees to pay employee at least **50% of highest annualized base salary** paid in the 2 years before termination, **pro-rata for entire restricted period**, without unilateral discontinuation (except for employee breach).
- **Enforceability criteria**: Restriction must be reasonable in duration (typically 1–2 years enforced), geography, and type of work prohibited.
- **Employer must prove**: Legitimate business interest (trade secrets, confidential information, customer relationships, substantial relationship with prospective/existing clients).
- **Less restrictive alternatives**: Employer should first employ non-disclosure, non-solicitation, or trade secrets law protection before non-compete.
...
**Independent contractor classification (ABC test, M.G.L. c. 149 § 148B)**:

- Massachusetts applies strict **ABC test**; all three prongs must be satisfied; default presumption is employee status.
- **(A)** Individual is free from employer direction/control in performing services, both contractually and in fact.
- **(B)** Service is performed outside usual course of employer's business or outside all employer locations.
- **(C)** Individual is customarily engaged in independently established trade, occupation, or profession of the same nature.
- Misclassification enforced by Massachusetts Department of Labor, Department of Revenue Services, Attorney General, and Workers' Compensation Commission.
...
1. **Pay transparency**: Before posting job or extending offer, platform must require entry of pay range; system must timestamp disclosure to applicant (effective 10/29/25 for employers with 25+ employees).

2. **Final pay due date**: On discharge, platform must calculate and trigger payment by same business day; on resignation, by next regular payday.

3. **Treble damages flag**: Any delay in final pay triggers automatic exposure to 3x damages plus attorney fees (M.G.L. c. 149 § 150); platform should block final pay submission if amount is incomplete.

4. **Salary history inquiry block**: Platform must prevent user from requesting or recording prior wage history from external candidates; flag as unlawful if attempted.
...
8. **Personnel record notification**: On promotion or pay change, platform must generate employer reminder to notify employee within 10 days if new information is added to personnel file that negatively affects qualification for employment, promotion, or compensation.

9. **Non-compete/non-solicit**: If non-compete exists, platform must verify garden leave payment (50% salary, pro-rata) and track restricted period; flag any restriction without garden leave as likely unenforceable post-M.G.L. c. 149 § 24L amendment; require documentation of 10+ business days for legal review.

10. **Wage range in promotion offer**: On promotion, platform must require entry of new pay range (Frances Perkins Act, § 105F); existing employee (not new hire) must receive range disclosure.

11. **Pay data reporting**: For employers with 100+ MA employees, platform must prompt annual/biennial EEO-1 filing reminder (due with Commonwealth Secretary, effective 2/1/25).

12. **At-will exceptions flag**: On termination, platform must prompt user to confirm no at-will exception applies (wage claim filed, public policy violation, jury duty, statutory right exercise).

**Field restrictions and validations**:

- **Salary history field**: Make read-only or invisible for external candidates; flag if user attempts manual entry.
- **Pay range in posting/offer**: Mandatory field for employers with 25+ employees (effective 10/29/25).
- **Overtime classification**: Default non-exempt; require documented justification for executive, professional, outside sales, agricultural, or domestic exemptions.
- **Sick leave accrual override**: Disable manual override; system calculates per statute.
- **PFML contribution rate**: Auto-calculate per headcount threshold (25+ = 0.88%, <25 = 0.46%); update on 1/1/27 for contribution shift.
- **Final pay amount**: Require itemization (salary, accrued sick leave, accrued vacation, other earned compensation); system blocks submission if items are missing or incomplete.

**Open questions for legal review**:

- Verify current status and enforcement funding for M.G.L. c. 151A §§ 71A–71B plant-closing law.
