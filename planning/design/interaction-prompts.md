...
Use case: ui-mockup. Targeted correction to this Human Capital Management Suite design board. Preserve the two-panel layout, all styling, employee panel and Jordan proposal. Correct only the manager panel: scope dropdown must say My team, not People Operations. Cross-team coverage card for Avery Patel MUST NOT disclose any medical or leave reason: replace Medical Leave with Coverage needed, replace date with Begins Sep 8, 2026, retain Covered by Taylor Kim. No medical text anywhere.

### 03-worker-profile

Use case: ui-mockup. Targeted correction to this Human Capital Management Suite design board. Preserve layout, green style and the Jordan current-versus-proposed separation. Fix only these details: sidebar active selection must be People, not Home. The right Reports to card must say Alex Morgan with initials AM and title Strategy Manager (not Elena Ruiz). Remove the invented Team 6 direct reports card and replace with Work context showing Strategy, New York, NY, Current role: Senior Analyst. Pay summary badge must read Sensitive · authorized instead of Restricted, since this authorized principal can view it.

### 04-promotion-draft

Use case: ui-mockup. Targeted correction to this Human Capital Management Suite design board. Preserve this entire form, values, validation inset and style. Correct the acting user in top right from Noah Williams NW to Alex Morgan AM, the authorized requester. Highlight People in sidebar instead of Home. Add a small readable identity line beneath Promotion draft: PR-1042 · Revision 3 · Draft. Nothing is submitted or executed.
