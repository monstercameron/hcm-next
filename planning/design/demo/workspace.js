(() => {
  ...
  function applyTheme() {
    ...
    $("hcm-brand-name").textContent =
      company === "Northstar Group" ? "Human Capital Management Suite" : company;
  ...
  $("hcm-reset").addEventListener("click", (event) =>
    simulate(
      () => {
        ...
        toast(
          "Defaults restored",
          "Brand, layout, density, and navigation returned to Human Capital Management Suite defaults.",
        );
      },
