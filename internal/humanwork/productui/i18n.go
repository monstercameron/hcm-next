...
var productMessages = map[string]map[string]localize.Message{
	"en-US": {
		...
		"action_launcher.trigger": {Text: "Start an action"}, "action_launcher.dialog_title": {Text: "Start an action"}, "action_launcher.filter_label": {Text: "Filter authorized actions"}, "action_launcher.filter_placeholder": {Text: "Filter actions"}, "action_launcher.empty_title": {Text: "No actions available"}, "action_launcher.empty_description": {Text: "No authorized action is available for this identity right now."},
		...
		"headcount.unavailable_title": {Text: "Requisition service unavailable"}, "headcount.unavailable_detail": {Text: "Requesting headcount requires the governed requisition service, which is not published yet. The UI will not simulate one."}, "headcount.return_home": {Text: "Return to live workspace"},
		...
		"position.unavailable_title": {Text: "Position service unavailable"}, "position.unavailable_detail": {Text: "Requesting positions requires the governed position service, which is not published yet. The UI will not simulate one."}, "position.return_home": {Text: "Return to live workspace"},
		...
		"page.admin.label": {Text: "Admin"}, "page.admin.title": {Text: "Admin"}, "admin.journeys_unavailable_reason": {Text: "The journey service did not respond, so journey actions stay unavailable."}, "admin.studio_unavailable_reason": {Text: "This cell publishes no page-configuration service."}, "page.admin.subtitle": {Text: "Published service capabilities and configuration availability."},
	...
	"de-DE": {
		"context_switcher.single": {Text: "Nur ein autorisierter Kontext ist verfügbar"}, "context_switcher.switching": {Text: "Arbeitsbereichskontext wird gewechselt…"}, "context_switcher.failed": {Text: "Der Arbeitsbereichskontext konnte nicht gewechselt werden. Versuchen Sie es erneut."}, "context_switcher.switch_to": {Text: "Zu {tenant}, {acting} wechseln"}, "context_switcher.current_context": {Text: "{tenant}, {acting}, aktuell"}, "context_switcher.elevated": {Text: "Erweiterter Zugriff"},
		...
		"action_launcher.trigger": {Text: "Aktion starten"}, "action_launcher.dialog_title": {Text: "Aktion starten"}, "action_launcher.filter_label": {Text: "Autorisierte Aktionen filtern"}, "action_launcher.filter_placeholder": {Text: "Aktionen filtern"}, "action_launcher.empty_title": {Text: "Keine Aktionen verfügbar"}, "action_launcher.empty_description": {Text: "Für diese Identität ist derzeit keine autorisierte Aktion verfügbar."},
		...
		"page.organization.label": {Text: "Organisation"}, "page.organization.title": {Text: "Organisation"}, "page.insights.label": {Text: "Einblicke"}, "page.insights.title": {Text: "Einblicke"}, "page.admin.label": {Text: "Administration"}, "page.admin.title": {Text: "Administration"}, "admin.journeys_unavailable_reason": {Text: "Der Journey-Dienst hat nicht geantwortet, daher bleiben Journey-Aktionen unverfügbar."}, "admin.studio_unavailable_reason": {Text: "Diese Zelle veröffentlicht keinen Seitenkonfigurationsdienst."}, "page.appearance.label": {Text: "Marke & Darstellung"}, "page.appearance.title": {Text: "Marke & Darstellung"}, "page.studio.label": {Text: "Experience Studio"}, "page.studio.title": {Text: "Experience Studio"}, "page.help.label": {Text: "Hilfe"}, "page.help.title": {Text: "Hilfe-Center"}, "page.settings.label": {Text: "Einstellungen"}, "page.settings.title": {Text: "Einstellungen"}, "page.settings.subtitle": {Text: "Aktuelle authentifizierte Sitzung und verfügbare Einstellungen."},
	...
	"ar": {
		"context_switcher.single": {Text: "يتوفر سياق مصرح به واحد فقط"}, "context_switcher.switching": {Text: "جارٍ تبديل سياق مساحة العمل…"}, "context_switcher.failed": {Text: "تعذر تغيير سياق مساحة العمل. حاول مرة أخرى."}, "context_switcher.switch_to": {Text: "التبديل إلى {tenant}، {acting}"}, "context_switcher.current_context": {Text: "{tenant}، {acting}، الحالي"}, "context_switcher.elevated": {Text: "وصول مرفوع الصلاحية"},
		...
		"action_launcher.trigger": {Text: "بدء إجراء"}, "action_launcher.dialog_title": {Text: "بدء إجراء"}, "action_launcher.filter_label": {Text: "تصفية الإجراءات المصرّح بها"}, "action_launcher.filter_placeholder": {Text: "تصفية الإجراءات"}, "action_launcher.empty_title": {Text: "لا توجد إجراءات متاحة"}, "action_launcher.empty_description": {Text: "لا يوجد إجراء مصرّح به لهذه الهوية حالياً."},
		...
		"page.home.label": {Text: "الرئيسية"}, "page.home.title": {Text: "الرئيسية"}, "page.myself.label": {Text: "ملفي"}, "page.myself.title": {Text: "ملفي"}, "page.myself.subtitle": {Text: "معلومات التوظيف والمؤسسة والرواتب وسير العمل الخاصة بك."}, "page.journeys.label": {Text: "الرحلات"}, "page.journeys.title": {Text: "الرحلات"}, "page.work.label": {Text: "عملي"}, "page.work.title": {Text: "عملي"}, "page.history.label": {Text: "سجل العمل"}, "page.history.title": {Text: "سجل سير العمل"}, "page.people.label": {Text: "الأشخاص"}, "page.people.title": {Text: "الأشخاص"}, "page.person.label": {Text: "الشخص"}, "page.person.title": {Text: "ملف الشخص"}, "page.organization.label": {Text: "المؤسسة"}, "page.organization.title": {Text: "المؤسسة"}, "page.insights.label": {Text: "الرؤى"}, "page.insights.title": {Text: "الرؤى"}, "page.admin.label": {Text: "الإدارة"}, "page.admin.title": {Text: "الإدارة"}, "admin.journeys_unavailable_reason": {Text: "لم تستجب خدمة الرحلات، لذا تبقى إجراءات الرحلات غير متاحة."}, "admin.studio_unavailable_reason": {Text: "لا تنشر هذه الخلية خدمة تكوين الصفحات."}, "page.appearance.label": {Text: "العلامة التجارية والمظهر"}, "page.appearance.title": {Text: "العلامة التجارية والمظهر"}, "page.help.label": {Text: "المساعدة"}, "page.help.title": {Text: "مركز المساعدة"}, "page.settings.label": {Text: "الإعدادات"}, "page.settings.title": {Text: "الإعدادات"}, "page.settings.subtitle": {Text: "الجلسة المصادق عليها حاليًا والتفضيلات المتاحة."},
