...
var productMessages = map[string]map[string]localize.Message{
	"en-US": {
		...
		"page.organization_visibility.label": {Text: "Organization visibility"}, "page.organization_visibility.title": {Text: "Organization visibility"}, "page.organization_visibility.subtitle": {Text: "Control which organization units ordinary users can discover."},
		"organization_visibility.eyebrow": {Text: "DIRECTORY ACCESS"}, "organization_visibility.heading": {Text: "Set the workforce visibility boundary"}, "organization_visibility.description": {Text: "This organization-wide rule is applied by the server before worker records reach the browser."},
		...
		"organization_visibility.units_title": {Text: "Qualified organization units"}, "organization_visibility.units_help": {Text: "Selections are used by the allowlist and denylist modes. They remain saved when another mode is active."}, "organization_visibility.boundary_title": {Text: "Server-enforced boundary"}, "organization_visibility.boundary_detail": {Text: "Hidden workers, organization-unit names, and reporting links are removed from ListWorkers. A worker can always receive their own record; compensation administrators retain complete access to administer this policy."}, "organization_visibility.save": {Text: "Save visibility policy"}, "organization_visibility.status": {Text: "Changes are organization-wide and version checked."},
