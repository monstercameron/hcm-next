...
var productMessages = map[string]map[string]localize.Message{
	"en-US": {
		...
		"work.promotion_journeys": {Text: "Promotion journeys"}, "work.all": {Text: "All work"}, "work.awaiting": {Text: "Awaiting approval"}, "work.blocked": {Text: "Blocked"}, "work.past": {Text: "Past workflows"}, "work.item_count": {Plural: map[string]string{"one": "{count} item", "other": "{count} items"}},
		...
		"people.table_aria": {Text: "Authorized people"}, "people.column.person": {Text: "Person"}, "people.column.role": {Text: "Role"}, "people.column.team": {Text: "Team"}, "people.column.manager": {Text: "Manager"}, "people.column.location": {Text: "Location"},
		...
		"appearance.brand_signature": {Text: "Brand signature"}, "appearance.brand_help": {Text: "Give the workspace a recognizable customer name and short text mark."}, "appearance.workspace_name": {Text: "Workspace name"}, "appearance.workspace_name_help": {Text: "Shown in the global product header"}, "appearance.short_mark": {Text: "Short mark"}, "appearance.short_mark_help": {Text: "Up to three letters, numbers, or &"},
	...
	"de-DE": {
		...
		"page.organization.label": {Text: "Organisation"}, "page.organization.title": {Text: "Organisation"}, "page.insights.label": {Text: "Einblicke"}, "page.insights.title": {Text: "Einblicke"}, "page.admin.label": {Text: "Administration"}, "page.admin.title": {Text: "Administration"}, "page.appearance.label": {Text: "Marke & Darstellung"}, "page.appearance.title": {Text: "Marke & Darstellung"}, "page.studio.label": {Text: "Experience Studio"}, "page.studio.title": {Text: "Experience Studio"}, "page.help.label": {Text: "Hilfe"}, "page.help.title": {Text: "Hilfe-Center"}, "page.settings.label": {Text: "Einstellungen"}, "page.settings.title": {Text: "Einstellungen"},
		...
		"work.promotion_journeys": {Text: "Beförderungsabläufe"}, "work.all": {Text: "Alle Aufgaben"}, "work.awaiting": {Text: "Wartet auf Genehmigung"}, "work.blocked": {Text: "Blockiert"}, "work.past": {Text: "Vergangene Abläufe"}, "work.item_count": {Plural: map[string]string{"one": "{count} Eintrag", "other": "{count} Einträge"}}, "work.authorized": {Text: "Ihre autorisierten Aufgaben"}, "work.view": {Text: "Meine Aufgaben anzeigen →"}, "work.nothing_selected": {Text: "Nichts ausgewählt"}, "work.show_all": {Text: "Alle Aufgaben anzeigen"}, "work.server_proposal": {Text: "Vom Server gemeldeter Vorschlag"}, "work.effective_date": {Text: "Wirksamkeitsdatum"}, "work.current_base": {Text: "Aktuelles Grundgehalt"}, "work.proposed_base": {Text: "Vorgeschlagenes Grundgehalt"}, "work.journey_id": {Text: "Ablauf-ID"}, "work.open_journey": {Text: "Live-Ablauf öffnen"},
		"people.filter_placeholder": {Text: "Nach Name, Rolle, Team, Standort oder Personalnummer filtern"}, "people.filter_aria": {Text: "Mitarbeitende filtern"}, "people.filter": {Text: "Filtern"}, "people.clear": {Text: "Löschen"}, "people.find": {Text: "Mitarbeitende suchen"}, "people.table_aria": {Text: "Autorisierte Mitarbeitende"}, "people.column.person": {Text: "Person"}, "people.column.role": {Text: "Rolle"}, "people.column.team": {Text: "Team"}, "people.column.manager": {Text: "Führungskraft"}, "people.column.location": {Text: "Standort"}, "people.pages": {Text: "Mitarbeitendenseiten"}, "people.range": {Text: "{first}–{last} von {total}"}, "people.page_count": {Text: "Seite {page} von {pages}"}, "people.empty_title": {Text: "Keine Mitarbeitenden gefunden"}, "people.clear_filter": {Text: "Filter löschen"},
	...
	"ar": {
		...
		"page.home.label": {Text: "الرئيسية"}, "page.home.title": {Text: "الرئيسية"}, "page.journeys.label": {Text: "الرحلات"}, "page.journeys.title": {Text: "الرحلات"}, "page.work.label": {Text: "عملي"}, "page.work.title": {Text: "عملي"}, "page.history.label": {Text: "سجل العمل"}, "page.history.title": {Text: "سجل سير العمل"}, "page.people.label": {Text: "الأشخاص"}, "page.people.title": {Text: "الأشخاص"}, "page.person.label": {Text: "الشخص"}, "page.person.title": {Text: "ملف الشخص"}, "page.organization.label": {Text: "المؤسسة"}, "page.organization.title": {Text: "المؤسسة"}, "page.insights.label": {Text: "الرؤى"}, "page.insights.title": {Text: "الرؤى"}, "page.admin.label": {Text: "الإدارة"}, "page.admin.title": {Text: "الإدارة"}, "page.appearance.label": {Text: "العلامة التجارية والمظهر"}, "page.appearance.title": {Text: "العلامة التجارية والمظهر"}, "page.help.label": {Text: "المساعدة"}, "page.help.title": {Text: "مركز المساعدة"}, "page.settings.label": {Text: "الإعدادات"}, "page.settings.title": {Text: "الإعدادات"},
	},
}
