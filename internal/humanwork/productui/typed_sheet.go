...
// disabledRule scopes parts to :disabled on the enclosing selector.
func disabledRule(parts ...any) []gwccss.Rule {
	return gwccss.Disabled(gwccss.Rules(parts...)...)
}

// notDisabledRule scopes parts to :not(:disabled) on the enclosing selector.
func notDisabledRule(parts ...any) []gwccss.Rule {
	return gwccss.Not(gwccss.Sel(":disabled"), gwccss.Rules(parts...)...)
}
