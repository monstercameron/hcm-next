...
func PageVisible(page PageID, roles []string) bool {
	...
	case PagePortal:
		...
		return true
	case PageMyself, PageTimeHub, PageTimeEntry, PageTimeCorrection, PageOrganization:
