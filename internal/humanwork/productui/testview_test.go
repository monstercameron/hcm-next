...
func testView(page PageID) View {
	...
	view.People = []Person{
		...
		{ID: "worker-avery", Initials: "AP", PhotoURL: "/workspace/assets/person-jane-small.jpg", Name: "Avery Patel", Role: "DES2 · G6", Team: "Product", Location: "Toronto", WorkerNumber: "NW-40118", JobCode: "DES2", Grade: "G6", PositionID: "pos-design", PayZone: "CA-ON", BasePay: testMoney("118000", "CAD"), BonusTarget: "0.12", HireDate: "2022-04-11", Source: "CREATED"},
