...
// TestMain starts the one embedded PostgreSQL instance every DB-backed test in
// this package shares, per WF-STEP-003's instruction that DB-backed tests use
// pgtest.New(t).
