...
func (d *Driver) CommitGoverned(ctx context.Context, prepared plan.TransactionPlan, req transactioncancel.Request) (GovernedCommitResult, error) {
...
func (d *Driver) CancelGoverned(ctx context.Context, req transactioncancel.Request, compensator transactioncancel.Compensator) (GovernedCommitResult, error) {
	if d == nil || d.opts.DB == nil {
