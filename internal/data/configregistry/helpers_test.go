...
// insertTenant registers a minimal tenant row, matching
// internal/data/governance/governance_test.go's own helper.
...
// role migration 00008 declares, matching every other pgtest-backed suite's
// own helper.
