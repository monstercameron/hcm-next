// Package processroles implements the SVC-001 process-role and
// semantic-ownership policy: matching definitions/architecture/process-roles.yaml
// against the actual cmd/* directories.
