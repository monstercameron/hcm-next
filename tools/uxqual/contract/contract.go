...
// contract for UX-001 (planning/todos.md).
//
// The contract is a plain Go value: no GoWebComponents type, no
// html/template type, and no import of internal/intent/app or
// internal/domains (this lane owns tools/uxqual and definitions/ux only, and
// other lanes own those packages; UX-QUAL-001's fixture uses testdata copied
// into this package instead).
//
