...
// FuzzTodo_FORM_004 is the FUZZ matrix test for FORM-004. It fuzzes the four
...
func FuzzTodo_FORM_004(f *testing.F) {
	f.Add("worker-1048", "Registered Nurse III", "$98,000.00", "2026-10-01", "Scope of practice increase.")
	f.Add("", "", "", "", "")
	f.Add("worker-1", "Title\nwith\nnewlines", "$0.00", "not-a-date", "")
	f.Add("worker-2", "Título con acentos áéíóú", "€1.234,56", "2026-13-40", "原因说明")

	f.Fuzz(func(t *testing.T, workerID, jobTitle, compensation, effectiveDate, reason string) {
