...
var gov018Allowlist = buildAllowlistKeys("GOV-018", func(add func(id, code, detail string)) {
	...
	addGOV018CSV(add, CodeMissingApplicableTestClass, "INTEGRATION", "ACCESS-001,ADMIN-002,ADMIN-003,ADMIN-005,ADMIN-006,ADMIN-007,AGENT-001,AGENT-002,AGENT-003,AGENT-004,AGENT-005,APP-001,APP-002,APP-003,APP-004,APP-005,APP-006,CLOSE-002,ENDPOINT-001,ENDPOINT-009,EQUITY-002,LEARN-006,LIB-016,LIB-019,LIB-020,NEXT-002,OBS-010,OBS-011,OBS-013,OBS-017,PHASE-001,PROOF-002,PROTO-009,PROTO-010,RECRUIT-001,SEARCH-001,SEARCH-002,SLICE-010,TOOL-021,TOOL-023,TOOL-024")
