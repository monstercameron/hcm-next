...
func TestTodo_GOV_023_Conformance(t *testing.T) {
	...
	if !strings.Contains(stdout.String(), "riskbinding: PASS") || !strings.Contains(stdout.String(), "allowlisted gap") {
		t.Fatalf("stdout = %q, want PASS and allowlisted gap diagnostics", stdout.String())
	}
}
