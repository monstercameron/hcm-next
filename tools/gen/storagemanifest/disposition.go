...
var entityHints = map[string]physicalHint{
	...
	"principal":                     {kind: DispositionTable, table: "principal"},
	"authority_source":              {kind: DispositionTable, table: "authority_source"},
	"authority_binding":             {kind: DispositionTable, table: "authority_binding"},
	"authentication_session":        {kind: DispositionTable, table: "authentication_session"},
	"delegation_grant":              {kind: DispositionTable, table: "delegation_grant"},
	"authorization_policy_snapshot": {kind: DispositionTable, table: "authorization_policy_snapshot"},
	"authorization_decision":        {kind: DispositionTable, table: "authorization_decision"},
	"data_access_manifest":          {kind: DispositionTable, table: "data_access_manifest"},
	"jurisdiction":                  {kind: DispositionTable, table: "jurisdiction"},
	"legal_rule_pack":               {kind: DispositionTable, table: "legal_rule_pack"},
	"rule_evaluation":               {kind: DispositionTable, table: "rule_evaluation"},
	"obligation":                    {kind: DispositionTable, table: "obligation"},
	"obligation_binding":            {kind: DispositionTable, table: "obligation_binding"},
	"evidence_artifact":             {kind: DispositionArtifact, table: "evidence_artifact"},
	"evidence_manifest":             {kind: DispositionTable, table: "evidence_manifest"},
	"governance_decision_bundle":    {kind: DispositionTable, table: "governance_decision_bundle"},
}
