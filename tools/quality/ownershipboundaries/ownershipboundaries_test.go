...
func TestTodo_ARCH_GO_022_Browser(t *testing.T) { TestHumanInteractionBoundariesAllowOwnerPackages(t) }
func TestTodo_ARCH_GO_022_Conformance(t *testing.T) {
	TestHumanInteractionBoundariesAllowOwnerPackages(t)
}
func TestTodo_ARCH_GO_022_Golden(t *testing.T)      { TestHumanInteractionBoundaries(t) }
func TestTodo_ARCH_GO_022_Integration(t *testing.T) { TestHumanInteractionBoundaries(t) }
func TestTodo_ARCH_GO_022_Mutation(t *testing.T)    { TestHumanInteractionBoundaries(t) }
func TestTodo_ARCH_GO_022_Race(t *testing.T)        { TestCheckIsDeterministic(t) }
