...
export const PERMISSION_KEYS = {
  ...
  CONTACT_INFO_REQUEST: "employee_data_change.contact_info.request",
  CONTACT_INFO_CANCEL_OWN: "employee_data_change.contact_info.cancel_own",
  CONTACT_INFO_APPROVE: "employee_data_change.contact_info.approve",
  CONTACT_INFO_REJECT: "employee_data_change.contact_info.reject",
  CONTACT_INFO_EXECUTE: "employee_data_change.contact_info.execute",
  ...
  COMPENSATION_REQUEST: "employee_data_change.compensation.request",
  COMPENSATION_CANCEL_OWN: "employee_data_change.compensation.cancel_own",
  COMPENSATION_APPROVE: "employee_data_change.compensation.approve",
  COMPENSATION_REJECT: "employee_data_change.compensation.reject",
  COMPENSATION_EXECUTE: "employee_data_change.compensation.execute",
